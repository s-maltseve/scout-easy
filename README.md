...
## Исправления версии 0.5.1

- токен административных действий генерируется автоматически при новой установке;
- пустой или отсутствующий `SCOUT_ACTION_TOKEN` автоматически восстанавливается при обновлении;
- токен имеет длину 64 символа и содержит буквы разных регистров, цифры и спецсимволы;
- существующие непустые логин, пароль и токен сохраняются;
- устранена ошибка `SCOUT_ACTION_TOKEN: unbound variable`;
- менеджер создаёт строку токена, даже если её не было в конфигурации.
